...
const (
	...
	EntryType_EntryRead       EntryType = 2
)
...
func (EntryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_052464ef033eac62, []int{0}
}
...
const (
	...
	MessageType_MsgTick        MessageType = 16
)
...
func (MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_052464ef033eac62, []int{1}
}
...
func (ConfChangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_052464ef033eac62, []int{2}
}
...
type Message struct {
	...
	Hint                 uint64      `protobuf:"varint,11,opt,name=hint,proto3" json:"hint,omitempty"`
	HintHigh             uint64      `protobuf:"varint,12,opt,name=hint_high,json=hintHigh,proto3" json:"hint_high,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_052464ef033eac62, []int{3}
}
...
func (*HardState) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_052464ef033eac62, []int{4}
}
...
func (*ConfState) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_052464ef033eac62, []int{5}
}
...
func (*ConfChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_052464ef033eac62, []int{6}
}
...
func (m *ConfChange) GetKey() uint64 {
	if m != nil {
		return m.Key
	}
	return 0
...
func (m *ReadIndexCtx) Reset()         { *m = ReadIndexCtx{} }
func (m *ReadIndexCtx) String() string { return proto.CompactTextString(m) }
func (*ReadIndexCtx) ProtoMessage()    {}
func (*ReadIndexCtx) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_052464ef033eac62, []int{7}
}
func (m *ReadIndexCtx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReadIndexCtx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReadIndexCtx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *ReadIndexCtx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadIndexCtx.Merge(dst, src)
}
func (m *ReadIndexCtx) XXX_Size() int {
	return m.Size()
}
func (m *ReadIndexCtx) XXX_DiscardUnknown() {
	xxx_messageInfo_ReadIndexCtx.DiscardUnknown(m)
}

var xxx_messageInfo_ReadIndexCtx proto.InternalMessageInfo

func (m *ReadIndexCtx) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *ReadIndexCtx) GetDeadline() uint64 {
	if m != nil {
		return m.Deadline
	}
	return 0
...
type ReadyToRead struct {
	Ctx                  *ReadIndexCtx `protobuf:"bytes,1,opt,name=ctx" json:"ctx,omitempty"`
	Index                uint64        `protobuf:"varint,2,opt,name=index,proto3" json:"index,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
...
func (m *ReadyToRead) Reset()         { *m = ReadyToRead{} }
func (m *ReadyToRead) String() string { return proto.CompactTextString(m) }
func (*ReadyToRead) ProtoMessage()    {}
func (*ReadyToRead) Descriptor() ([]byte, []int) {
	return fileDescriptor_eraftpb_052464ef033eac62, []int{8}
}
func (m *ReadyToRead) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReadyToRead) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ReadyToRead.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *ReadyToRead) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadyToRead.Merge(dst, src)
}
func (m *ReadyToRead) XXX_Size() int {
	return m.Size()
}
func (m *ReadyToRead) XXX_DiscardUnknown() {
	xxx_messageInfo_ReadyToRead.DiscardUnknown(m)
}

var xxx_messageInfo_ReadyToRead proto.InternalMessageInfo

func (m *ReadyToRead) GetCtx() *ReadIndexCtx {
	if m != nil {
		return m.Ctx
	}
	return nil
...
func (m *ReadyToRead) GetIndex() uint64 {
	if m != nil {
		return m.Index
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*ReadIndexCtx)(nil), "eraftpb.ReadIndexCtx")
	proto.RegisterType((*ReadyToRead)(nil), "eraftpb.ReadyToRead")
...
func (m *Message) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Hint != 0 {
		dAtA[i] = 0x58
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.Hint))
	}
	if m.HintHigh != 0 {
		dAtA[i] = 0x60
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.HintHigh))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *ConfChange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Key != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.Key))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *ReadIndexCtx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReadIndexCtx) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.Deadline != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.Deadline))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *ReadyToRead) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReadyToRead) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Ctx != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.Ctx.Size()))
...
func (m *Message) Size() (n int) {
	...
	if m.Hint != 0 {
		n += 1 + sovEraftpb(uint64(m.Hint))
	}
	if m.HintHigh != 0 {
		n += 1 + sovEraftpb(uint64(m.HintHigh))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ReadIndexCtx) Size() (n int) {
	var l int
	_ = l
	if m.Id != 0 {
	...
	if m.Deadline != 0 {
		n += 1 + sovEraftpb(uint64(m.Deadline))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ReadIndexCtx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReadIndexCtx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReadIndexCtx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ReadyToRead) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReadyToRead: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReadyToRead: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func init() { proto.RegisterFile("eraftpb.proto", fileDescriptor_eraftpb_052464ef033eac62) }

var fileDescriptor_eraftpb_052464ef033eac62 = []byte{
	// 799 bytes of a gzipped FileDescriptorProto
	,
}
